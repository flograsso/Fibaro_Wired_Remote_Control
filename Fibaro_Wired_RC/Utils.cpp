      ...
      while (cortinaActual != cortinaNumber)
      {
            ...
            switch(cortinaNumber)
            {
                  ...
                  case 3:
                        ...
                        !(analogRead(channelArray[4].LEDpinADC) > (channelArray[4].normalVoltajeLED * 0.6) )) blinkChannel(channelArray[cortinaNumber].buttonSelectCHShifter);
                        break;
                  case 4:
                        while (((millis() - init < 1500) && (analogRead(channelArray[cortinaNumber].LEDpinADC) > (channelArray[cortinaNumber].normalVoltajeLED * 0.6))) || 
                        !(analogRead(channelArray[3].LEDpinADC) > (channelArray[3].normalVoltajeLED * 0.6) ))blinkChannel(channelArray[cortinaNumber].buttonSelectCHShifter);
                        break;
                  case 5:
                  case 6:
                        while (((millis() - init < 1500) && (analogRead(channelArray[cortinaNumber].LEDpinADC) > (channelArray[cortinaNumber].normalVoltajeLED * 0.6))) || 
                        !(analogRead(channelArray[7].LEDpinADC) > (channelArray[7].normalVoltajeLED * 0.6) )) blinkChannel(channelArray[cortinaNumber].buttonSelectCHShifter);
                        break;
                  case 7:
                        while (((millis() - init < 1500) && (analogRead(channelArray[cortinaNumber].LEDpinADC) > (channelArray[cortinaNumber].normalVoltajeLED * 0.6))) || 
                        !(analogRead(channelArray[5].LEDpinADC) > (channelArray[5].normalVoltajeLED * 0.6) ))blinkChannel(channelArray[cortinaNumber].buttonSelectCHShifter);
                        break;
                  case 8:   
